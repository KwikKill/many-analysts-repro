...
**AI-Generated Analysis Notes**: This entire analysis (code, statistical tests, visualizations, and interpretation) was generated by an LLM. The experiment demonstrates that modern AI can:
